import { Edit, TextInput, BooleanInput, TabbedForm, List, DataTable, useGetRecordId, NumberInput, FormDataConsumer, Toolbar, SaveButton, DeleteButton, FileField, FileInput, useRecordContext, useNotify, Button } from "react-admin";
